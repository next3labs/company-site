...
accelerates the wrong work. And underneath both questions sits the sorting that makes
any of it safe to delegate: [which decisions an agent may hold at
all](/blog/ai-that-runs-a-whole-company/) — by the rule it follows and what it costs
